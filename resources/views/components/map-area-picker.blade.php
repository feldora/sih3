...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Tambahkan fungsi calculateDistance agar bisa dipakai di calculateKeliling
            ...
            var markersPolygon = [];
            var polygon = null;
            var coordinatesPolygon = @json($oldCoordinates ?: []);

            // Variabel untuk marker dan garis yang mengikuti kursor
            ...
            function updatePolygon() {
                ...
                if (coordinatesPolygon.length >= 3) {
                    ...
                    document.getElementById('keliling-info').textContent = 'Keliling Area: ' + formatDistance(
                        keliling);
                } else {
