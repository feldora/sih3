...
<div class="contmx-auto p-4 bg-white shadow-md rounded-lg">
    ...
    <div class="flex justify-end items-center mb-6 gap-5">
        ...
        <a href="{{ route('admin.pos-pengamatan.import-excel.form') }}" class="btn btn-sm mb-4 btn-success">Tambah Dari Excel</a>
    ...
    <div class="overflow-x-auto bg-white rounded shadow">
        <table class="table w-full">
            ...
            <tbody>
                @foreach($posPantau as $index => $pos)
                <tr>
                    {{-- Nomor urut disesuaikan dengan offset halaman --}}
