...
@section('content')
    <div class="container mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        <form action="{{ route('admin.menus.store') }}" method="POST">
            ...
            <!-- Permission Name -->
            <div class="mb-4">
                <label for="permission_name" class="block text-sm font-medium text-gray-700">Permission Name
                    (Optional)</label>
                <input type="text" name="permission_name" id="permission_name" value="{{ old('permission_name') }}"
                    class="form-input mt-1 block w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
