...
@section('title', 'Edit Data Cekungan Air Tanah')

@section('content')
<div class="container mx-auto px-4">
    <div class="card bg-base-100 shadow-xl my-6 p-6 rounded-xl">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Edit Data Cekungan Air Tanah</h1>
            <a href="{{ route('admin.cat.index') }}" class="btn btn-secondary">
                <i class="fas fa-arrow-left mr-2"></i>Kembali
            </a>
        </div>

        <form action="{{ route('admin.cat.update', $cekunganAirTanah->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="form-control">
                    ...
                    <input type="text" name="nama_cat" value="{{ old('nama_cat', $cekunganAirTanah->nama_cat) }}" 
                ...
                <div class="form-control">
                    ...
                    <input type="number" step="0.01" name="luas_cat_ha" value="{{ old('luas_cat_ha', $cekunganAirTanah->luas_cat_ha) }}" 
                ...
                <div class="form-control">
                    ...
                    <input type="number" step="0.01" name="potensi_air_tanah_bebas" value="{{ old('potensi_air_tanah_bebas', $cekunganAirTanah->potensi_air_tanah_bebas) }}" 
                ...
                <div class="form-control">
                    ...
                    <input type="number" step="0.01" name="potensi_air_tanah_tertekan" value="{{ old('potensi_air_tanah_tertekan', $cekunganAirTanah->potensi_air_tanah_tertekan) }}" 
            ...
            <div class="flex justify-end gap-2">
                <a href="{{ route('admin.cat.index') }}" class="btn btn-ghost">Batal</a>
